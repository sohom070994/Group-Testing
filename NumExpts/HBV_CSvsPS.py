...
for w1 in tqdm(list(range(0, 1, 2)),desc='lambda loop',position=0,leave=True):
    for w2 in list(range(0,1,2)):
        if(w1+w2<=10):
            lambda_1=w1/10
            lambda_2=w2/10
            ...
            for sim in tqdm(range(0,simulations),desc='sim loop',position=0,leave=True):
                ...
                if ((lambda_1+lambda_2) == 1):
                    ...
                    current_node_list=list(range(0,100,18))
                    current_node_list.reverse()
...
# #%% 8. OUTPUT TO CSV
# results.to_csv('HBV_CSvsPS001.csv')          
...
for w1 in tqdm(range(0, 1, 2),desc='lambda loop',position=0,leave=True):
    for w2 in range(0,1,2):
        if(w1+w2<=10):
            lambda_1=w1/10
            lambda_2=w2/10

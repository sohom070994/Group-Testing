...
def get_risk_vector():
   ...
   #   risk_vec[i]=round(coin_flip()/100,4)
    ...
    elements = [0.032, 0.011, 0.045, 0.157, 0.05, 0.01]
    probabilities = [0.024, 0.357, 0.258, 0.003, 0.039, 0.319]
...
#%% 8. OUTPUT TO CSV
results.to_csv('Old_Dist_CS6.csv')          

   ...
   for w2 in list(range(0,12,1)):
       ...
       if(w1+w2<=10):
           ...
           results = results.append({'w1':lambda_1,
                                     'w2':lambda_2,
                                     'OF_ND':str(round(np.mean(of_nd),4))+"+-"+str(0.196*np.std(of_nd)),
                                     
                                     
                                     
                                     'OF_D':str(round(np.mean(of_d),4))+"+-"+str(0.196*np.std(of_d)),

                                     
                                     'OF_CS':str(round(np.mean(of_cs),4))+"+-"+str(0.196*np.std(of_cs)),
...
results.to_csv('Results50sims222.csv')

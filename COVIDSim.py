...
# lambda_1 = 0.96 #weight on EFN
# lambda_2 = 0.02 #weight on EFP
...
of_bs,et_bs,efp_bs,efn_bs,part_bs=BellmanGS(3,50)
# node_list=g_d.shortestPath(s) 
# part_d=len(node_list)
# of_d,et_d,efp_d,efn_d=calc_meas(node_list)
#%% 7. SIMULATIONS
...
results.to_csv('Bellman15Sim_Modified.csv')